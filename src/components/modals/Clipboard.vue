    ...
    <div class="modal-content fm-modal-clipboard">
        ...
        <div class="modal-body">
            <template v-if="clipboard.type">
                <span>{{ lang.clipboard.actionType }} - {{ lang.clipboard[clipboard.type] }}</span>
                <hr>
                <span><i class="far fa-hdd"></i>{{ clipboard.disk }}</span>
                <hr>
...
export default {
  ...
  computed: {
    ...
    // get paths and names for directories
    directories() {
